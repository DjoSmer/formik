...
import { Formik, Field, ErrorMessage } from 'formik2nd';
...
#### `state.errors: { [field: string]: string }`
...
#### `state.touched: { [field: string]: boolean }`
